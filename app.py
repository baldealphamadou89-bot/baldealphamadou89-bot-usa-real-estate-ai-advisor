...
# --- FONCTION POUR LE LOGO (ENCADRÉ ET STABLE) ---
...
logo_data = get_base64_from_url(LOGO_URL)
...
# --- SÉLECTION DE LA LANGUE (CORRIGÉE) ---
...
with col_logo:
    if logo_data:
        st.markdown(f'<img src="data:image/png;base64,{logo_data}" width="150">', unsafe_allow_html=True)
    else:
        st.title("🏠")
